...
/** Defined in its own module so proxy.ts can share it without importing this
 *  file's `server-only`/`next/headers` dependencies. Imported (not just
 *  re-exported) because this module uses it locally too. */
